...
const Data = [
  {
    ...
    duties: [
      ...
      "I have completed the Degree with the highest points. I finished the last project on the track which was deploying a Full stack website on AWS.",
      "I have completed a project (Attendance App) for my college which was a full stack website that connected to an embedded project on RFID Based Attendance System to visualize student data in real-time (internet of things). I manage to complete the project on my own, the project has a database to store data and a backend server which converts student data to Excel sheets using NodeJS ",
  ...
  },
  {
    ...
    duties: [
      ...
      "I have more than three years of experience as a front-end developer. Currently, I am trying to master React Native.",
